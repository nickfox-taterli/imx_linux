				 ...
				 struct snd_soc_dai *dai)
{
	...
	//uda1380_write(codec, UDA1380_CLK, 0xF3A);
	return 0;
}
	...
	enum snd_soc_bias_level level)
{
	...
	//	uda1380_write(codec, UDA1380_PM, R02_PON_BIAS | R02_PON_LNA);
		uda1380_write(codec, UDA1380_PM,  R02_PON_LNA | R02_PON_BIAS | R02_PON_ADCL);
		break;
...
static int uda1380_probe(struct platform_device *pdev)
{
	...
	case UDA1380_DAC_CLK_WSPLL:
		...
		uda1380_write(codec, UDA1380_CLK, R00_EN_ADC | R00_EN_DEC | R00_DAC_CLK | 0x22);
		break;
	}

	uda1380_write(codec, UDA1380_DEEMP, 0x800);
	snd_soc_add_controls(codec, uda1380_snd_controls,
				ARRAY_SIZE(uda1380_snd_controls));
	uda1380_add_widgets(codec);
#if 0	
	//uda1380_write(codec, UDA1380_PGA,  (21 << 8) | (21 << 0));
//	uda1380_write(codec, UDA1380_DEC,   0);
	uda1380_write(codec, UDA1380_DEC,   (0x8F < 8) | (0x8F < 0));
	//uda1380_write(codec, UDA1380_PGA,   0x0);
	uda1380_write(codec, UDA1380_PGA,   0x803 | (0x1 << 15));
	uda1380_write(codec, UDA1380_ADC,    0x105);
	//uda1380_write(codec, UDA1380_ADC,    0x0205);
	uda1380_write(codec, UDA1380_AGC,  (3 << 2) | 1);
#endif
	//uda1380_write(codec, UDA1380_DEC,   0);
	uda1380_write(codec, UDA1380_ADC,    (1 << 12) | (0x1 << 8) | 0x0d);
...
static int uda1380_register(struct uda1380_priv *uda1380)
{
	...
	#if 0 //modify by cxf for uda1380
