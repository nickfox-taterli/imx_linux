...
#if defined(CONFIG_SND_SOC_UDA1380) || defined(CONFIG_SND_SOC_UDA1380_MODULE)
static struct uda1380_platform_data uda1380_info = {
        .dac_clk = UDA1380_DAC_CLK_WSPLL,
};

static struct i2c_board_info __initdata mxs_i2c_uda1380_device[] = {
        {
...
static void __init i2c_device_init(void)
{
	...
	//modify by cxf for uda1380
        #if defined(CONFIG_SND_SOC_UDA1380) || defined(CONFIG_SND_SOC_UDA1380_MODULE)
        i2c_register_board_info(1, mxs_i2c_uda1380_device, ARRAY_SIZE(mxs_i2c_uda1380_device));
        #endif
}
