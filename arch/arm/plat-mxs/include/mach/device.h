...
struct mxs_auart_plat_data {
	...
	const char *clk;
	int (*dir_set)(unsigned pinid,int value);
};
...
struct easy283_pwm_platform_data {
	int pwm_ch;
	int max_intensity;
        int default_intensity;
        int (*init_pwm) (struct easy283_pwm_platform_data *);
        int (*set_pwm_duty) (struct easy283_pwm_platform_data*,
                             int);
        void (*free_pwm) (struct easy283_pwm_platform_data*);
};
