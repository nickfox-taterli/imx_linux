...
#if defined(CONFIG_SND_SOC_UDA1380) || \
        defined(CONFIG_SND_SOC_UDA1380_MODULE)
static struct platform_device mxs_uda1380[] = {
        {
        .name = "mxs-uda1380",
        .id = 0,
        .dev =  {
...
static struct platform_device mxs_hsadc = {
	.name = "mxs-hsadc",
	.id = 0,
	.dev = {
		.release = mxs_nop_release,
...
static struct platform_device easy283_pwms[] = {
